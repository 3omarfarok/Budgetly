...
const useDishwashing = (houseId) => {
  ...
  const {
    ...
    queryKey: queryKeys.dishwashing.settings(houseId),
    queryFn: async () => {
  ...
  const {
    ...
    queryKey: queryKeys.dishwashing.today(houseId),
    queryFn: async () => {
  ...
  const {
    ...
    queryKey: queryKeys.dishwashing.schedule(houseId),
  ...
  const updateSettingsMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.dishwashing.all(houseId) });
